        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center justify-between w-full gap-4">
            <div className="flex items-center gap-4 flex-grow">
              ...
              {(showSearch || isWideScreen) && (
                <div
                  className={`relative flex-grow max-w-xs transition-transform duration-300 ease-in-out ${
                ...
                >
                  <input
                    ...
                    className="w-full px-4 py-2 rounded-md bg-white text-[#252A3E] placeholder-[#97A0CC] border border-[#97A0CC] focus:outline-none focus:ring-2 focus:ring-[#97A0CC] transition-all dark:bg-[#3D4466] dark:text-white dark:placeholder-[#BCC2E0] dark:border-[#4F5784]"
                  />
                </div>
              )}
            </div>
            ...
            <div className="flex items-center gap-2">
              <button
                className="sm:hidden text-[#252A3E] dark:text-white p-2"
          ...
          {(showSearch || isWideScreen) && (
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-4 w-full sm:w-auto sm:ml-auto">
              {warning && (
                <span className="self-center text-sm text-red-600 dark:text-red-400 mt-1 block animate-shake">
                  ⚠️ {warning}
                </span>
              )}

...
import PokemonDetailHeader from "../components/detail/pokemon-header";
import PokemonDetailImage from "../components/detail/pokemon-image";
import PokemonInfo from "../components/detail/pokemon-info";
...
const Detail: React.FC = () => {
    ...
    return (
        <div className="min-h-screen text-white dark:text-[#2e3a59] flex justify-center items-center px-4 overflow-x-hidden transition-colors duration-300 bg-[#F0F3FF] dark:bg-[#252A3E]">
        <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            className="max-w-md w-full bg-[#FFFFFF] dark:bg-[#1B1F2F] rounded-2xl p-6 sm:p-14 shadow-xl shadow-[#00000020] dark:shadow-[#00000040]"
        >
            <BackButton />
